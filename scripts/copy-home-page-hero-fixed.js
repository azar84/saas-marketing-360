...
async function copyHomePageHeroFixed() {
  console.log('🏠 Copying Home Page Hero data with fixed field mapping...');
          ...
          try {
            ...
            await targetPrisma.$queryRaw`
              INSERT INTO home_page_hero (
                ...
                ${null}, ${null}, ${null}, ${null},
                ${hero.mediaUrl}, ${hero.backgroundValue}, ${null},
...
// Run the copy
copyHomePageHeroFixed().then((count) => {
  console.log('\n' + '='.repeat(80));

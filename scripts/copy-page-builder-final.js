...
async function copyPageBuilderDataFinal() {
  console.log('🚀 Copying page builder data (final attempt)...');
  ...
  try {
    ...
    // Copy PageSection data with manual column mapping
...
// Run the copy
copyPageBuilderDataFinal().catch(console.error); 